...
} --time 30 --interval 1 --json --version4 -P 10 | jq -c '{start: .start, intervals: .intervals, end: .end }' | aws s3 cp - "s3://ec2throughput.info/results/${safeClientInstanceType}/${new Date()
  .toISOString()
  .slice(0, 10)}.json"
`;
